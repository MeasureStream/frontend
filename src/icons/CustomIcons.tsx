export const PressureIcon = ({ size = 24, className = "" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 30 30" // Viewbox ottimizzato per il path fornito
    fill="currentColor" // Applica il colore del testo al riempimento del path
    className={className}
  >
...
// --- ICONA ACCELEROMETRO (3D Rotation) ---
export const AccelIcon = ({ size = 24, className = "" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
