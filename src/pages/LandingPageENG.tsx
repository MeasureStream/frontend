...
const options = (loginUrl?: string): Option[] => [
  {
    icon: <BsBoxArrowInRight size={22} />,
    titleKey: "landing.signIn",
    textKey: "landing.signInText",
    highlighted: true,
    onClick: () => { if (loginUrl) window.location.href = loginUrl; },
  },
  {
    icon: <BsGraphUp size={22} />,
    titleKey: "landing.discover",
    textKey: "landing.discoverText",
    highlighted: false,
    onClick: () => document.getElementById("features")?.scrollIntoView({ behavior: "smooth" }),
  },
  {
    icon: <BsEnvelope size={22} />,
    titleKey: "landing.requestAccess",
    textKey: "landing.requestAccessText",
    highlighted: false,
  ...
  return (
    <div>
      ...
      <Container className="py-5">
        <Row className="g-0 rounded-4 overflow-hidden shadow-lg animated-hero" style={{ minHeight: '420px' }}>
          ...
          <Col md={7} className="bg-white p-5">
            <h3 className="fw-bold mb-1">{t("landing.welcome")}</h3>
              ...
              {options(loginUrl).map((o) => (
                ...
                >
                  ...
                  <div className="flex-grow-1">
                    ...
                    <div className="text-muted small">{t(o.textKey)}</div>
                  </div>
      ...
      <section id="features" className="py-5 ">
        <Container>
          <h2 className="text-center mb-4 fw-bold">{t("landing.features")}</h2>
          <Row className="g-4">
            <Col md={4}>
              <Card className="feature-card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                ...
                <Card.Body>
                  <Card.Title className="fw-bold">{t("landing.feature1Title")}</Card.Title>
            ...
            <Col md={4}>
              <Card className="feature-card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                ...
                <Card.Body>
                  <Card.Title className="fw-bold">{t("landing.feature2Title")}</Card.Title>
                  <Card.Text className="text-muted">
            ...
            <Col md={4}>
              <Card className="feature-card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                ...
                <Card.Body>
                  <Card.Title className="fw-bold">{t("landing.feature3Title")}</Card.Title>
                  <Card.Text className="text-muted">
      ...
      <section id="benefits" className="bg-white py-5">
        <Container className="text-center">
          <h2 className="mb-3 fw-bold">{t("landing.benefits")}</h2>
          <p className="text-muted mx-auto" style={{ maxWidth: '700px' }}>
            {t("landing.benefitsText")}
          </p>
        </Container>
      </section>
      ...
      <section id="contact" className="py-5 bg-light">
        <Container className="text-center">
          <h2 className="mb-3 fw-bold">{t("landing.contact")}</h2>
          ...
          <div>
            <Button variant="outline-primary" className="fw-bold px-4 rounded-pill" href="mailto:support@measurestream.com">
              {t("landing.contactButton")} <BsArrowRight className="ms-1" />
            </Button>
          </div>
        </Container>
      </section>
      ...
      <footer className="bg-primary text-white py-4 text-center">
        <Container>
          <p className="mb-0 small">{t("landing.rights")}</p>
        </Container>
      </footer>
    </div>
  );
